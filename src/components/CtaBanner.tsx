  ...
  return (
    <section className="py-20 bg-gradient-to-r from-primary to-secondary text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 transform translate-y-[-50%]">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-8xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xlmax-w-4xl mx-auto">
            You want to grow, you want to have a beautiful website, to market yourself and bring more clients in, but you don't have the time or the expertise to do it? Don't worry, we'll help you.
          </p>
        </div>
      </div>
    </section>
